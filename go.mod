...
require (
	...
	dies.dev/diegen v0.8.0 // indirect
	...
	github.com/vmware-tanzu/carvel-imgpkg v0.36.2 // indirect
	github.com/vmware-tanzu/tanzu-source-controller v0.8.0-build.1 // indirect
